...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 08, 2022 at 06:34 AM
...
CREATE TABLE `attendee` (
  ...
  `avatar_path` int(200) DEFAULT NULL
...
ALTER TABLE `attendee`
  ...
  ADD KEY `kk_attendee_specialties` (`specialty_id`);
...
--
ALTER TABLE `attendee`
  ADD CONSTRAINT `kk_attendee_specialties` FOREIGN KEY (`specialty_id`) REFERENCES `specialties` (`specialty_id`);
COMMIT;
